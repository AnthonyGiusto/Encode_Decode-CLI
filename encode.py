def encode(index):
    """Takes a user input value and encodes it
    with a predefined month index"""
    ...
    # User-input for the number to be encoded into a code-string
    plainnumber = input("enter plain number: ")
    digitlist = []
    codeindex = codelist[index]
    for digit in plainnumber:
        digit = int(digit)
        digitlist.append(digit)
    for digit in digitlist:
        print(codeindex[digit], end="")
